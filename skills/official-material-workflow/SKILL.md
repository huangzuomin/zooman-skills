---
name: official-material-workflow
description: 任务判断、资料组织、证据分级、草稿生成、审稿门禁、归档规范，并保留中文公文与行政正式文本的起草、改写、润色、压缩、规范和 Word docx 导出能力。Use when the user asks to write, revise, summarize, standardize, audit, package, or convert 机关材料、公文、决议、决定、命令、公告、公报、通告、意见、通知、通报、报告、请示、批复、议案、函、纪要，以及总结、简报、新闻简报、信息专报、舆情专报、汇报材料、讲话稿、工作方案、实施方案、改革方案、政策建议、领导简报、项目报告、年度报告、回复函等正式机关或单位文稿；尤其适用于需要文种判断、行文方向判断、证据等级、统一口径、审稿报告、待核实清单、草案包、规范标题、层级编号、落款日期、模板套用或 Word docx 导出的场景。
metadata: {"openclaw": {"homepage": "https://github.com/huangzuomin/zooman-skills/tree/main/skills/official-material-workflow", "requires": {"bins": ["bash", "python3", "curl"]}}}
---
...
- 先读取共享总规则。
- 先判断当前任务是否需要专家工作流：模糊任务、高风险任务、领导决策、政策建议、舆情专报、公开/保密/合法性事项优先输出草案包。
- 明确文种、材料充分且风险较低时，可直接进入成稿；否则先输出任务简报、写作资料包、证据与口径说明、正式文稿草案、审稿报告和待核实清单。
- 判断当前任务最匹配的文种、材料类型和行文方向。
...
- 当前导出脚本已支持标题、正文、层级标题的字体字号区分，也支持固定行距、正文首行缩进、标题自动断行和页码显示；页码默认自第二页起显示，首页不显示页脚页码，页脚本身不设置显式底纹或高亮。
